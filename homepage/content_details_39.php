    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Ice mint</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/ai-generated-8675021_1280.png" alt="Ice mint" class="product-image">
                    <h2 class="product-title">Ice mint</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Image of ice stacked up on each other with mint</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/ai-generated-8675021_1280.png" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
