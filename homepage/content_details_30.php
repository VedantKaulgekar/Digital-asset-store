    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Protect your characters</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/shield.png" alt="Protect your characters" class="product-image">
                    <h2 class="product-title">Protect your characters</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: A shield 3d model</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/roman_scutum_-_pristine_model.glb" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
