    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Hello world</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/hello_world.jpeg" alt="Hello world" class="product-image">
                    <h2 class="product-title">Hello world</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Hello world desktop wallpaper</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/hello_world.jpeg" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
