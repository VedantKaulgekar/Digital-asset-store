...
?>
                <div class="product-container">
                    <img src="/Used images/unicorn-8376844_1280.jpg" alt="Unicorn" class="product-image">
                    <h2 class="product-title">Unicorn</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: A drawing of a unicorn</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/unicorn-8376844_1280.jpg" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
