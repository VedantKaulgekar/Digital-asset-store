    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Electricity usage dataset</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/electricitydataset-cover.jpg" alt="Electricity usage dataset" class="product-image">
                    <h2 class="product-title">Electricity usage dataset</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: India's electricity usage dataset</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/electricity-consumption-india-city-level-2017-19.csv" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
