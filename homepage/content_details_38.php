    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Mountains</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/login-bg.jpg" alt="Mountains" class="product-image">
                    <h2 class="product-title">Mountains</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Painting of mountains teal in colour</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/login-bg.jpg" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
