    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Highest rating movies</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/moviesdataset.png" alt="Highest rating movies" class="product-image">
                    <h2 class="product-title">Highest rating movies</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: A dataset of highest rating movies</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/movies.csv" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
