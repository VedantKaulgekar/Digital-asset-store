    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Research articles datasets</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/researcharticlesdataset.png" alt="Research articles datasets" class="product-image">
                    <h2 class="product-title">Research articles datasets</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Dataset of research articles regarding physics and computer science</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/phys_and_computsci_articles.csv" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
