...
?>
                <div class="product-container">
                    <img src="/Used images/Kaizen.jpg" alt="Kaizen" class="product-image">
                    <h2 class="product-title">Kaizen</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: HOW TO CREATE ANY HABIT WITH KAIZEN</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/kaizen.pdf" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
