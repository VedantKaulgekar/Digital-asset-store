    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Youtube outro</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/Screenshot 2024-04-25 193241.png" alt="Youtube outro" class="product-image">
                    <h2 class="product-title">Youtube outro</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: A youtube outro video</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/93028-639008110_small.mp4" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
