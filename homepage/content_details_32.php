    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Violet nature</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/earthday-8692504_1280.png" alt="Violet nature" class="product-image">
                    <h2 class="product-title">Violet nature</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Rainy violet background</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/earthday-8692504_1280.png" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
