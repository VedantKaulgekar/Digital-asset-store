    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Hidden stripes</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/tiger-8436227_640.jpg" alt="Hidden stripes" class="product-image">
                    <h2 class="product-title">Hidden stripes</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: An image of tiger hiding behind the leaves</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/tiger-8436227_640.jpg" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
