    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Once in paris</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/Once in paris.jpg" alt="Once in paris" class="product-image">
                    <h2 class="product-title">Once in paris</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Once in paris song</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/once-in-paris-168895.mp3" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
