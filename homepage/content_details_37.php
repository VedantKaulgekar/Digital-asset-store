    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-Mushrooms</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/2024-04-25.png" alt="Mushrooms" class="product-image">
                    <h2 class="product-title">Mushrooms</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: Video of mushrooms in the forest</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/204525-924724199_small.mp4" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
