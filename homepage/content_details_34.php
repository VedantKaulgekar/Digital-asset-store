    ...
    <link rel="stylesheet" href="homepage.css">
                <title> Pixel Art-A round table object</title>
                <style>
                    body {
...
?>
                <div class="product-container">
                    <img src="/Used images/Table.png" alt="A round table object" class="product-image">
                    <h2 class="product-title">A round table object</h2>
                    <div class="product-info">
                        <p>Uploaded by: Vedant</p>
                        <p>Description: A round side table 3d object</p>
                    </div>
      ...
      // Include the login-page.php file
        ...
        if($started) {
            // If logged in, redirect to profile page
          echo '<button id="downloadButton"> <a href="/Used images/classic_round_side_table.glb" download> Download Now </a></button>';
        } else {
            // If not logged in, redirect to login page
